...
Name: Polygon
Version: 3.0a1
Summary: Polygon eases the handling of 2D-polygons including very fast clipping operations
Home-page: http://polygon.origo.ethz.ch/
Author: Joerg Raedler
Author-email: jr@j-raedler.de
License: LGPL for Polygon, other for gpc
Download-URL: http://polygon.origo.ethz.ch/download
Description: 
