...
class table__p_o_s_t(DefaultTable.DefaultTable):
	...
	def decode_format_2_0(self, data, ttFont):
		...
		if numGlyphs > ttFont[b'maxp'].numGlyphs:
			...
			numGlyphs = ttFont[b'maxp'].numGlyphs
		data = data[2:]
		...
		self.glyphOrder = glyphOrder = [None] * int(ttFont[b'maxp'].numGlyphs)
		...
		if numGlyphs < ttFont[b'maxp'].numGlyphs:
			for i in range(numGlyphs, ttFont[b'maxp'].numGlyphs):
	...
	def build_psNameMapping(self, ttFont):
		mapping = {}
		allNames = {}
		for i in range(ttFont[b'maxp'].numGlyphs):
...
def unpackPStrings(data): # in Python3, data is a byte array
        strings = []
        index = 0
        dataLen = len(data)
        while index < dataLen:
